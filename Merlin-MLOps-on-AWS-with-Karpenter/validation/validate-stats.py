...
if __name__ == "__main__":
    ...
    # You can adjust features and thresholds as needed
    # This is just an example focusing on the I1 feature (first integer feature)
    ...
    # Convert the .pb2 to dict for easier processing
    drift = MessageToDict(drift_anomalies)

    if 'driftSkewInfo' in drift and len(drift['driftSkewInfo']) > 0:
        ...
        drift_detected = value >= threshold
        logging.info(f"Drift detected: {drift_detected}")
        
    else:
        logging.info("No drift measurements found in the anomalies")
