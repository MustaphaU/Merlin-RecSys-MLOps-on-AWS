...
def create_pipeline(data_extraction_image: str, data_validation_image: str, preprocess_train_image: str, deploy_image: str, monitoring_image: str):
    ...
    def merlin_pipeline(
        ...
        new_data_dir: str = 'incremental_data_dir_in_your_bucket',
        ...
        sqs_queue_url: str = 'your-sqs-queue-url, e.g. https://sqs.aws_region.amazonaws.com/aws_account_id/queue_name',
