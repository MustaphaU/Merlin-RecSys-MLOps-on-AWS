...
Please visit *[(documentation/setup_instructions.md)](https://github.com/MustaphaU/Merlin-RecSys-MLOps-on-AWS/blob/main/Merlin-MLOps-on-AWS-with-with-Cluster_Autoscaler/documentation/SETUP_INSTRUCTIONS.md)* to deploy in your AWS account.
