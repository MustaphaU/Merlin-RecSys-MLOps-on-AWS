...
if __name__ == "__main__":
    ...
    parser.add_argument('-d',
                        ...
                        type=str,
                        required=False,
                        default='/workspace/data/criteo/day_1.parquet',
                        help='Path to a test .parquet file on persistent volume.')
    ...
    parser.add_argument('-b',
                        ...
                        required=False,
                        default=64,
                        help='Batch size. Max is 64 at the moment, but this max size could be specified when creating the model and the ensemble.')
    ...
    col_dtypes = [np.int32]*26 + [np.int32]*13 #updated to int32
